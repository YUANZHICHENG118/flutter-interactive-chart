...
class DataUtil {
  static calculate(List<CandleData> dataList,
    ...
    calcKDJ(dataList);
    calcMACD(dataList);
    calculateRSI(dataList, 6, (CandleData, rsi) => CandleData.rsi1 = rsi);
    calculateRSI(dataList, 12, (CandleData, rsi) => CandleData.rsi2 = rsi);
    calculateRSI(dataList, 24, (CandleData, rsi) => CandleData.rsi3 = rsi);
    calcWR(dataList);
    calcCCI(dataList);
    return dataList;
  }
  ...
  static void calculateRSI(List<CandleData> dataList, int period, Function(CandleData, double?) setRSI) {
    double? rsi;
    double rsiABSEma = 0;
    double rsiMaxEma = 0;
    for (int i = 0; i < dataList.length; i++) {
